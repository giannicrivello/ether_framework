...
if __name__ == "__main__":
    ...
    joblib.dump(label_encoders, "models/{}_label_encoder.pkl".format(MODEL))
    joblib.dump(clf, "models/{}.pkl".format(MODEL))
    joblib.dump(train_df.columns, "models/{}_columns.pkl".format(MODEL))
